...
namespace Microsoft.Kinect.Toolkit.FaceTracking
{
    ...
    /// </summary>
    /// Frente superior direita = 1
    /// queixo superior = 9
    // queixo inferior = 10
    // Lado Direito do Queixo = 30
    // Boca do canto direito do lado direito = 31,
    // queixo direito = 32
    // labios = 33
    //Frente superior esquerda = 34

    //Lábio inferior superior médio = 40,
    //Lábio inferior inferior médio = 41,
    //Esquerda da sobrancelha esquerda = 48,
    //Médio superior da sobrancelha esquerda = 49,
    //Direita da sobrancelha esquerda = 50,
    // Parte inferior média da sobrancelha esquerda = 51,
    //Palpebra superior superior esquerda = 54,
    // Lado Esquerdo da bochecha = 63,
    // canto exterior esquerdo da boca = 64
    // Queixo esquerdo = 65
    // superior esquerdo  do labio = 66
    // labio superior superior direito = 79
    // LeftTopUpperLip                 = 80,
    // Lábio superior inferior direito = 81,
    // Lábio inferior esquerdo inferior = 82,
    // topo direito inferior do labio = 83
    // topo esquerdo inferior do labio = 84
    // Lábio inferior direito inferior = 85,
    // Lábio inferior esquerdo inferior = 86,
    // Lábio superior inferior médio = 87,
    // canto esquerdo da boca = 88
    // canto direito da boca = 89
    // inferior direito da bochecha = 90
    //inferior equerdo da bochecha = 91
